    ...
    return (
        <div className="font-mono text-base text-gray-200 leading-7">
            ...
            <p>
                ...
                <span className="text-yellow-400"> complex business logic</span>, real-world
                workflows, and critical user journeys such as claims, payments, and validations.
            </p>
            ...
            <p>
                ...
                <span className="text-purple-400"> broader engineering perspective </span>
                and better understand how systems communicate end-to-end.
            </p>
            ...
            <p>
                ...
                <span className="text-blue-400"> maintainable</span>, and
                <span className="text-blue-400"> well-structured</span>. I pay strong attention to
                <span className="text-pink-400"> performance optimization</span>,
                <span className="text-yellow-400"> accessibility </span>
...
export default DetailAboutContent;
