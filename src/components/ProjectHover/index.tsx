...
export default function ProjectWrapper() {
    ...
    const contentImages = LIST_PROJECT.map((item) => {
        const _image = item.image.url + "?fit=crop&w=220&h=320&exp=-10";
        return _image;
    });
                    ...
                    >
                        ...
                        >
                            <div className="flex flex-col">
                                <span className="text-3xl font-bold max-sm:text-xl">{name}</span>
                            ...
                            <span className="ml-auto flex items-center gap-2 text-xl font-medium md:ml-0 max-sm:text-sm">
                                View Project
                                <MdArrowOutward />
                            </span>
                        </Link>
